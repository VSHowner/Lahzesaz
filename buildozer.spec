...
# assets/, fonts/ و logo/ به‌صورت خودکار چون کنار main.py هستند و پسوندشون
# در source.include_exts هست، شامل می‌شوند؛ نیازی به include_patterns نیست.
...
requirements = python3,kivy==2.3.1,pyjnius,plyer,arabic-reshaper,python-bidi,requests,certifi,pillow
...
android.presplash_color = #FDEBEE
...
# INTERNET: برای آپلود آواتار (requests) و ارتباط با UPLOAD_URL
# CAMERA: برای گرفتن عکس پروفایل / خاطره با دوربین (plyer.camera)
# READ/WRITE_EXTERNAL_STORAGE: برای نسخه‌های قدیمی‌تر اندروید (maxSdkVersion=32)
# READ_MEDIA_IMAGES: برای اندروید ۱۳ به بالا هنگام انتخاب عکس از گالری
